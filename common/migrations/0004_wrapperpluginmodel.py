# Generated by Django 3.1.12 on 2021-09-02 10:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('common', '0003_coverpluginmodel_darken'),
    ]

    operations = [
        migrations.CreateModel(
            name='WrapperPluginModel',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='common_wrapperpluginmodel', serialize=False, to='cms.cmsplugin')),
